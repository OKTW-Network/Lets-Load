...
execute if score #forceload.signature.clear_chunk_area.clear_chunk_x letsload-internal > #forceload.signature.clear_chunk_area.chunk_x2 letsload-internal run function letsload:forceload/signature/clear_chunk_area/_clear/next_line
