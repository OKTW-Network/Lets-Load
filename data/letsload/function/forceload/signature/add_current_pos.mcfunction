...
scoreboard players operation #forceload.signature.add_chunk.chunk_x letsload-io = #util.get_current_chunk_coord.Result.x letsload-io
scoreboard players operation #forceload.signature.add_chunk.chunk_z letsload-io = #util.get_current_chunk_coord.Result.z letsload-io
