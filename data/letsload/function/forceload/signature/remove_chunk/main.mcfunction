...
scoreboard players reset #forceload.signature.remove_chunk.Result letsload-io
...
return run execute unless score #forceload.signature.remove_chunk.Result letsload-io matches 0 run scoreboard players get #forceload.signature.remove_chunk.Result letsload-io
