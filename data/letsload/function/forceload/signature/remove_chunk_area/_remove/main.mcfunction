...
execute if score #forceload.signature.remove_chunk_area.remove_chunk_x letsload-internal > #forceload.signature.remove_chunk_area.chunk_x2 letsload-internal run function letsload:forceload/signature/remove_chunk_area/_remove/next_line
...
function letsload:forceload/signature/remove_chunk_area/_remove/main
