...
execute as @e[distance=0..,limit=1,type=minecraft:marker,tag=letsload-forceload_anchor] if score @s letsload-forceload_anchor.chunk_x = #forceload.signature.query_chunk.chunk_x letsload-io if score @s letsload-forceload_anchor.chunk_z = #forceload.signature.query_chunk.chunk_z letsload-io run function letsload:forceload/signature/query_chunk/anchor_query
...
return run scoreboard players get #forceload.signature.query_chunk.Result letsload-io
