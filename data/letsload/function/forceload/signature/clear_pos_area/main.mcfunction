...
data modify storage letsload:internal dummy.x set from storage letsload:io forceload.signature.clear_pos_area.x1
data modify storage letsload:internal dummy.z set from storage letsload:io forceload.signature.clear_pos_area.z1
...
data modify storage letsload:internal dummy set value {x:"INVALID",y:0,z:"INVALID"}
data modify storage letsload:internal dummy.x set from storage letsload:io forceload.signature.clear_pos_area.x2
data modify storage letsload:internal dummy.z set from storage letsload:io forceload.signature.clear_pos_area.z2
execute store success score #1 temp run function letsload:util/lazy_get_chunk_coord/main with storage letsload:internal dummy
execute if score #1 temp matches 0 run return run function letsload:forceload/signature/clear_pos_area/_return_fail
...
execute store success score #1 temp run function letsload:forceload/signature/clear_chunk_area/main
execute if score #1 temp matches 0 run return run function letsload:forceload/signature/clear_pos_area/_return_fail
