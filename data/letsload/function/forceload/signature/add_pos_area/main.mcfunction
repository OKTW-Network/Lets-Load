...
scoreboard players reset #forceload.signature.add_pos_area.Result letsload-io
data modify storage letsload:internal dummy set value {x:"INVALID",y:0,z:"INVALID"}
data modify storage letsload:internal dummy.x set from storage letsload:io forceload.signature.add_pos_area.pos_x1
data modify storage letsload:internal dummy.z set from storage letsload:io forceload.signature.add_pos_area.pos_z1
...
data modify storage letsload:internal dummy set value {x:"INVALID",y:0,z:"INVALID"}
data modify storage letsload:internal dummy.x set from storage letsload:io forceload.signature.add_pos_area.pos_x2
data modify storage letsload:internal dummy.z set from storage letsload:io forceload.signature.add_pos_area.pos_z2
execute store success score #1 temp run function letsload:util/lazy_get_chunk_coord/main with storage letsload:internal dummy
execute if score #1 temp matches 0 run return run function letsload:forceload/signature/add_pos_area/_return_fail
...
execute store result score #forceload.signature.add_pos_area.Result letsload-io run function letsload:forceload/signature/add_chunk_area/main
...
return run execute unless score #forceload.signature.add_pos_area.Result letsload-io matches 0 run scoreboard players get #forceload.signature.add_pos_area.Result letsload-io
