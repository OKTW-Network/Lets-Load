...
scoreboard players operation #forceload.signature.add_chunk_area.chunk_x letsload-io = #util.lazy_get_chunk_coord.result.x letsload-io
scoreboard players operation #forceload.signature.add_chunk_area.chunk_z letsload-io = #util.lazy_get_chunk_coord.result.z letsload-io
