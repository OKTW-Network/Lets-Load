...
scoreboard players reset #forceload.anchor.create.Result letsload-io
...
execute store result score #forceload.anchor.create.Result letsload-io run function letsload:forceload/anchor/create/create/main with storage letsload:internal dummy
...
return run execute unless score #forceload.anchor.create.Result letsload-io matches 0 run scoreboard players get #forceload.anchor.create.Result letsload-io
