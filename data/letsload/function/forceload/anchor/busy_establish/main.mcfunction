execute unless score $forceload/anchor/busy_establish letsload-alert matches 0.. run scoreboard players set $forceload/anchor/busy_establish letsload-alert 0
...
scoreboard players operation $forceload/anchor/busy_establish letsload-alert *= #1 temp
