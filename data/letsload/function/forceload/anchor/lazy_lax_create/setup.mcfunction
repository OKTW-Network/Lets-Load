...
forceload add ~ ~
data merge entity @s {Tags:["letsload-forceload_anchor","TASK.letsload-forceload_anchor.check_in"],data:{"lestload:forceload_anchor":{register:[]}}}
return run function letsload:forceload/anchor/lax_add_signature
