...
return run execute unless score #forceload.anchor.query_signature.Result letsload-io matches 0 run scoreboard players get #forceload.anchor.query_signature.Result letsload-io
