...
execute if score #1 temp matches 1 unless data entity @s data."letsload:forceload_anchor".register[].signature run tag @s add TASK.letsload-forceload_anchor.check_out
